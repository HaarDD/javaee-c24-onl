...
@Slf4j
@Component
public class LocalAuthorizationService implements AuthorizationService, RegistrationService {

    private final FileServerSessionManager sessionManager;

    @Autowired
    public LocalAuthorizationService(FileServerSessionManager sessionManager) {
    ...
    public void register(String username, String password) {
        log.info("{}: Пользователь зарегистрирован: {}", this, username);
    }
}
